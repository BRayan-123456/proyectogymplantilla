            ...
            <tbody>
                <c:forEach var="dato" items="${lista}">
                     <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="agregarAsistencia.htm"><i class="fas fa-plus-circle"></i></a>
                            <a href="editarAsistencia.htm?idAsistencia=${dato.idAsistencia}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                            <a onclick="return confirm('Esta seguro?');"
                               href="deleteAsistencia.htm?idAsistencia=${dato.idAsistencia}" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
