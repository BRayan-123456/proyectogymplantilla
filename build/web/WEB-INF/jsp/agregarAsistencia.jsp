    ...
    <body style="background-image: url('images/mujerpiernas3.jpg');">
        <div class="container">
            ...
            <form method="POST" class="input" id="frm-registro">
                <h4 class="titulo">AGREGAR NUEVO ASISTENCIA</h4>
                <br>
                ...
                <div class="form-group">
                <label for="fecha"  class="label">Persona</label>
            ...
            <button type="" class="btn btn-danger"><a href="indexAsistencia.htm"><i class="fas fa-angle-double-left"></i></a></button>
            </div>
            </form>
        </div>
    </body>
